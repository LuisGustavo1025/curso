...
// aqui estamos criando um objeto, ou seja instanciando a classe empregado
$fulano = new Empregado();

// usando o objeto criado para cadastrar o empregado usando as informações digitadas no formulário
$fulano->cadastro($_POST{'nome'}, $_POST{'sobrenome'}, $_POST{'salario'});

// por último listamos os dados do empregado conforme está em nossa classe
